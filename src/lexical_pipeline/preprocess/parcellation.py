...
def main(
    ...
    **kwargs
    ...
    recon_dir = recon_dir or cfg.recon_dir
    ...
    subject_id = cfg.recon_id(subject)
    ...
    id_to_name = {}
    lut_path = str(_pkg_files("lexical_pipeline.data") / "FreeSurferColorLUT.txt")
    ...
    atlas_to_gross = {}
    mapping_path = str(_pkg_files("lexical_pipeline.data") / "a2009s.csv")
    ...
    for idx, row in elec_tsv.iterrows():
        ...
        if valid_labels.size == 0:
            ...
            percent_thresh = 0.05
            center_is_bad = any(bw in center_name for bw in bad_words)  # SUBSTRING match for center
        ...
        # Step 1: Default to Unknown if top1 fraction < 0.2
        if frac < 0.2:
            final_label = 'Unknown'
            final_roi = 'Unknown'
        else:
            ...
            for rank in [1, 2]:  # Check 2nd and 3rd
                ...
                if other_roi != top1_roi and other_frac > frac * 0.8:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--bids_root", default=None, type=str,
                        help="Root of the BIDS dataset (default: dataset.toml [paths].bids_root).")
    parser.add_argument("--recon_dir", default=None, type=str,
                        help="FreeSurfer/ECoG_Recon root (default: dataset.toml [paths].recon_dir).")
    parser.add_argument("--config", type=str, default=None,
                        help="Path to dataset.toml (default: $LEXPIPE_DATASET_CONFIG or upward search).")
    parser.add_argument("--ref", type=str, default='car', choices=['car', 'bipolar'],
    ...
    parser.add_argument("--subject", type=str, default='D0027',
